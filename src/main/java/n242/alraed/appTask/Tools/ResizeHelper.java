package n242.alraed.appTask.Tools;
...
public abstract class ResizeHelper {
    ...
    abstract public void doAfterResizing();

    public void addResizeListener(Stage stage) {
        addResizeListener(stage, 1, 1, Double.MAX_VALUE, Double.MAX_VALUE);
    }

    public void addResizeListener(Stage stage, double minWidth, double minHeight, double maxWidth, double maxHeight) {
    ...
    class ResizeListener implements EventHandler<MouseEvent> {
        ...
        public void handle(MouseEvent mouseEvent) {
            ...
            //edit by nameer.
            // see if the window is in the fullScreen mode or not.
            boolean ifFull = scene.getWindow().getX() == 0 && scene.getWindow().getY() == 0;

            if (MouseEvent.MOUSE_MOVED.equals(mouseEventType) && !ifFull) {
            ...
            } else if (MouseEvent.MOUSE_RELEASED.equals( mouseEventType ) && !(Cursor.DEFAULT.equals( cursorEvent ))) {
                //edited by nameer...
                doAfterResizing();
